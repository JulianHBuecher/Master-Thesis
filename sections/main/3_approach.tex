...
As there is a limited amount of available research and existing projects on reservation features for the management of \acrshortpl{cs} and charging infrastructure, the analysis and setup of the 'Open e-Mobility' \cite{noauthor_open_2023} solution and its particular components commenced a day earlier than planned.
