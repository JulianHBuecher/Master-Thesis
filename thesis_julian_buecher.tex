...
\mytitle{Reservation process for charging infrastructure management in the context of e--mobility}
...
% Main part
\include{sections/main/1_fundamentals}
\include{sections/main/2_requirements_engineering}
\include{sections/main/3_approach}
\include{sections/main/4_literature_review}
\include{sections/main/5_design}
\include{sections/main/6_implementation}
\include{sections/main/7_validation}
