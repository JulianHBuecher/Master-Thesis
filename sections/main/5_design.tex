...
For this reason, this system design outlines several scenarios that are considered by the author to be relevant for the solution to inform the user according to the changes made to the reservations. 
...
However, there should be a specific notification in the system design to inform the user when a reserved charging session is being cancelled. The system's implementation and internal administrative structure do not allow only the user who created the arrangement to cancel it. 
